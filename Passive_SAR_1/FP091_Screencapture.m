...
%    1.7  2014-04-28: Fixed bug when capturing interactive selection; only enable image formats when saving to an unspecified file via uiputfile
%    1.8  2014-11-16: Fixes for R2014b
%    1.9  2014-11-25: Fix for saving GIF files
%    1.10 2014-11-25: Added the 'printer' target
...
%    1.19 2022-11-23: Fixed clipboard capture on R2022a onward (reported by John Mullins)
%    1.20 2022-12-04: Fixed clipboard export to support transparent and gray-scale images
...
function imclipboard(imgData)
    ...
    % Create image buffer
    % Note: contrary to print2array which must use TYPE_INT_RGB,
    %       here we must use TYPE_INT_ARGB to preserve the alpha channel
