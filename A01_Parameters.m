...
Elem.TA  = -129.11;                             % [deg] True Anomaly - Satalliete position in the orbit
Elem.RAAN = 40.0;                              % [deg] Right Ascension Of Ascending Node - Ω angle is measured eastwards from x axis to ascending node on nodal line
Param.mu = 3.986e14;                            % [m3/s2] Earth's standard gravitational parameter
Param.T = 2*pi*sqrt(Elem.a^3/Param.mu);         % [s] Orbital period
Param.PRF = 2.5e3;                                % [Hz] Pulse Repeatition Frequency - PRF
...
Param.Margin = 1.1;                             % Range margin factor. This is a margin to include targets farther than swatch width, i.e. for larger squinet angle targets
%% Time
startTime = datetime('01-Jan-2022 11:00:00');   % [s] Set up the start time
