...
latLORA = MidSwath(1);                                        % LoRa Tx latitude has same latitude as mid of swath
lonLORA = MidSwath(2) - LORA.DeltaTheta;                         % LoRa Tx longitude is out of the swath longitude by 0.2 degree
