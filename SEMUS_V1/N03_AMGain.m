...
latAM = MidSwath(1);                                          % AM Tx latitude has same latitude as mid of swath
lonAM = MidSwath(2) - AM.DeltaTheta;                             % AM Tx longitude is out of the swath longitude by 0.2 degree
