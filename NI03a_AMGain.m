...
latAM = GRP(1) + AM.latShift;                             % AM Tx latitude has same latitude as mid of swath
lonAM = GRP(2) + AM.lonShift;                             % AM Tx longitude is out of the swath longitude by 0.2 degree
