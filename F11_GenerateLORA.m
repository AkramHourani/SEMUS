%% Define LORA Message
F12_LoRaGain                                                        % Generate the LoRa gain and power according to the required SIR
message = "Hello World!" ;
%% Transmit Signal
signalIQ = F13_LoRaTx(message,LORA.BW,LORA.SF,LORAPowerdB,LORA.fs,LORA.Delta_f) ;
%% Define LORA Timing
