...
Elem.TA  = 123.841;                              % [deg] True Anomaly - Satellite position in the orbit
Elem.RAAN = 193.89;                             % [deg] Right Ascension Of Ascending Node - Ω angle is measured eastwards from x axis to ascending node on nodal line
